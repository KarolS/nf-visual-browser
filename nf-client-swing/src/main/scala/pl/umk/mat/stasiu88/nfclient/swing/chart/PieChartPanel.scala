...
/**
 * A panel displaying a pie chart and the data table.
 * <br>
 * Panel wyświetlający wykres kołowy i tabelę z danymi.
 */
...
/**
 * A panel displaying a pie chart.
 * <br>
 * Panel wyświetlający wykres kołowy.
 */
